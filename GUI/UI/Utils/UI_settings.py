...
TRAINING_SESSION_PROMP = "Please enter a name for this training session: "

DATA_PROMPT_SOIL = "Enter the moisture (format: x.x, example: 1.3) or q to quit: "

DATA_PROMPT_VEGETABLE = "Enter the health (0 = not healthy, 1 = healthy) or q to quit: "
